...
async def test_jal_mul(dut):
  ...
  await asm_write(dut, 0x004, "mul x2 x1 x1") #   F F D X M W     (M-D)
  ...
  await asm_write(dut, 0x014, "mul x2 x1 x1") #     F D X M W     (M-D)
  ...
  await asm_write(dut, 0x024, "add x0 x0 x0") #     F D X M W
  await asm_write(dut, 0x028, "mul x2 x1 x1") #       F D X M W   (W-D)
  ...
  await asm_write(dut, 0x038, "add x0 x0 x0") #     F D X M W
  await asm_write(dut, 0x03c, "add x0 x0 x0") #       F D X M W
  await asm_write(dut, 0x040, "mul x2 x1 x1") #         F D X M W
  ...
  await RisingEdge(dut.clk)
  await check_trace(dut, 0x090)

  await check_trace(dut, 0x01c)
  await RisingEdge(dut.clk)
  await check_trace(dut, 0x000)
  await check_trace(dut, 0x310)

  await check_trace(dut, 0x030)
  await RisingEdge(dut.clk)
  await check_trace(dut, 0x000)
  await check_trace(dut, 0x000)
  await check_trace(dut, 0x900)
...
if __name__ == "__main__":
  ...
  if (test_case < 0) | (test_case == 5):
    run("Proc_mul_test", "test_jal_mul")