...
async def test_addi_sw(dut):
  ...
  await asm_write(dut, 0x038, "addi x1 x0 0x0f0")
  await asm_write(dut, 0x03c, "lw x1 0(x1)"     )
  await asm_write(dut, 0x040, "addi x1 x0 0x0f4")
  await asm_write(dut, 0x044, "lw x1 0(x1)"     )
  await asm_write(dut, 0x048, "addi x1 x0 0x0f8")
  await asm_write(dut, 0x04c, "lw x1 0(x1)"     )
  await asm_write(dut, 0x050, "addi x1 x0 0x0fc")
  await asm_write(dut, 0x054, "lw x1 0(x1)"     )
